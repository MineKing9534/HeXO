...
internal class SessionRepositoryImpl(private val client: HdsApiClient) : SessionRepository {
    ...
    override val lobbies = MutableStateFlow(emptyMap<SessionId, LobbySessionImpl>())
    ...
    private suspend fun populateLobbyList() {
        ...
        this.lobbies.value = lobbies.associate { it.id to LobbySessionImpl.of(this, client.profileRepository, it) }
    ...
    private fun SocketIOClient.registerLobbyListeners() {
        listen<LobbyUpdated> { event ->
            ...
            val newLobby = LobbySessionImpl.of(this@SessionRepositoryImpl, client.profileRepository, event.data)
