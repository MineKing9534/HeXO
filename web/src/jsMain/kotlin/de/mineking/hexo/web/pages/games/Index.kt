...
private enum class RatedFilter(val rated: Boolean?, private val label: String) {
    All(null, "All"),
    Rated(true, "Rated"),
    Casual(false, "Casual"),
    ;
...
fun GameHistoryPage() {
    ...
    if (client == null) {
        ...
        GameList(client.finishedGameRepository)
    }
}
...
@Composable
private fun GameList(finishedGameRepository: FinishedGameRepository) {
